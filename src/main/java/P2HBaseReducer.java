...
//
//                        //result.add(wco);
//                        String[] strings = wco.getTime().split("-");
//                        StringBuilder stringBuilder = new StringBuilder();
//                        if (wco.getUid().length() != 10) {
//                            for (int i = 0; i < 10 - wco.getUid().length(); i++) {
//                                stringBuilder.append("0");
//                            }
//                        }
//                        System.out.println(stringBuilder.toString() + wco.getUid() + strings[0]+strings[1]+strings[2] +  "\t"
//                                + strings[0]+strings[1]+strings[2] + "#" + wco.getWordcount());
//
...
////                    }
////                }
////                System.out.println(sb.toString() + wco.getUid() + strs[0]+strs[1]+strs[2] +  "\t"
////                        + strs[0]+strs[1]+strs[2] + "\t" + wco.getWordcount());
////            }
//
//
